...
################################################################
# This is a generated script based on design: dac_design
#
...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "handmadedds - 0 на втором канале" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DAC_CLKM [ create_bd_port -dir O -type clk DAC_CLKM ]
  set DAC_CLKP [ create_bd_port -dir O -type clk DAC_CLKP ]
  set DAC_DCIM [ create_bd_port -dir O -type clk DAC_DCIM ]
  set DAC_DCIP [ create_bd_port -dir O -type clk DAC_DCIP ]
  set DAC_DM [ create_bd_port -dir O -from 15 -to 0 DAC_DM ]
  set DAC_DP [ create_bd_port -dir O -from 15 -to 0 DAC_DP ]
  set DAC_FRAMEM [ create_bd_port -dir O DAC_FRAMEM ]
  set DAC_FRAMEP [ create_bd_port -dir O DAC_FRAMEP ]
  set DAC_RESET [ create_bd_port -dir O -from 0 -to 0 DAC_RESET ]
  set DAC_TXEN [ create_bd_port -dir O -from 0 -to 0 DAC_TXEN ]
  set SPI_CLK [ create_bd_port -dir O -type clk SPI_CLK ]
  set SPI_DATA [ create_bd_port -dir IO SPI_DATA ]
  set SPI_EN [ create_bd_port -dir O SPI_EN ]

  # Create instance: DifferentialOutBuffer_0, and set properties
  set DifferentialOutBuffer_0 [ create_bd_cell -type ip -vlnv rs.local:user:DifferentialOutBuffer:1.0 DifferentialOutBuffer_0 ]

  # Create instance: DifferentialOutBuffer_1, and set properties
  set DifferentialOutBuffer_1 [ create_bd_cell -type ip -vlnv rs.local:user:DifferentialOutBuffer:1.0 DifferentialOutBuffer_1 ]

  # Create instance: DifferentialOutBuffer_2, and set properties
  set DifferentialOutBuffer_2 [ create_bd_cell -type ip -vlnv rs.local:user:DifferentialOutBuffer:1.0 DifferentialOutBuffer_2 ]
  ...
  # Create instance: handmadedds_0, and set properties
  set handmadedds_0 [ create_bd_cell -type ip -vlnv rs.local:user:handmadedds:1.0 handmadedds_0 ]
  ...
  # Create instance: tribuffer_0, and set properties
  set tribuffer_0 [ create_bd_cell -type ip -vlnv rs.local:user:tribuffer:1.0 tribuffer_0 ]
  ...
  connect_bd_net -net DifferentialOutBuffer_0_outm [get_bd_ports DAC_CLKM] [get_bd_pins DifferentialOutBuffer_0/outm]
  connect_bd_net -net DifferentialOutBuffer_0_outp [get_bd_ports DAC_CLKP] [get_bd_pins DifferentialOutBuffer_0/outp]
  connect_bd_net -net DifferentialOutBuffer_1_outm [get_bd_ports DAC_DCIM] [get_bd_pins DifferentialOutBuffer_1/outm]
  connect_bd_net -net DifferentialOutBuffer_1_outp [get_bd_ports DAC_DCIP] [get_bd_pins DifferentialOutBuffer_1/outp]
  connect_bd_net -net DifferentialOutBuffer_2_outm [get_bd_ports DAC_FRAMEM] [get_bd_pins DifferentialOutBuffer_2/outm]
  connect_bd_net -net DifferentialOutBuffer_2_outp [get_bd_ports DAC_FRAMEP] [get_bd_pins DifferentialOutBuffer_2/outp]
  connect_bd_net -net Net [get_bd_ports SPI_DATA] [get_bd_pins tribuffer_0/data_io]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins tribuffer_0/data_cnt]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins handmadedds_0/clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins DifferentialOutBuffer_1/ins] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ila_0/probe2]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins ila_0/clk]
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins DifferentialOutBuffer_0/ins] [get_bd_pins clk_wiz_0/clk_out4]
  connect_bd_net -net handmadedds_0_IDDS [get_bd_pins handmadedds_0/IDDS] [get_bd_pins ila_0/probe0]
  connect_bd_net -net handmadedds_0_QDDS [get_bd_pins handmadedds_0/QDDS] [get_bd_pins ila_0/probe1]
  connect_bd_net -net handmadedds_0_doutn [get_bd_ports DAC_DM] [get_bd_pins handmadedds_0/doutn]
  connect_bd_net -net handmadedds_0_doutp [get_bd_ports DAC_DP] [get_bd_pins handmadedds_0/doutp]
  ...
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_pins processing_system7_0/SPI0_MOSI_O] [get_bd_pins tribuffer_0/data_in]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_ports SPI_CLK] [get_bd_pins processing_system7_0/SPI0_SCLK_O]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_ports SPI_EN] [get_bd_pins processing_system7_0/SPI0_SS_O]
  ...
  connect_bd_net -net tribuffer_0_data_out [get_bd_pins processing_system7_0/SPI0_MISO_I] [get_bd_pins tribuffer_0/data_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins handmadedds_0/reset] [get_bd_pins processing_system7_0/SPI0_MOSI_I] [get_bd_pins processing_system7_0/SPI0_SCLK_I] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_ports DAC_RESET] [get_bd_ports DAC_TXEN] [get_bd_pins DifferentialOutBuffer_2/ins] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins processing_system7_0/SPI0_SS_I] [get_bd_pins xlconstant_2/dout]
