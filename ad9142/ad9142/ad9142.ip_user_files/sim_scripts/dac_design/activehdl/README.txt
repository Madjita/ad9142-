...
#
# Generated by export_simulation on Fri Jul 13 10:15:16 +0700 2018
#
################################################################################
...
'-reset_run' switch to the './dac_design.sh' script.

./dac_design.sh -reset_run
...
./dac_design.sh -noclean_files

For more information on the script, please type './dac_design.sh -help'.
