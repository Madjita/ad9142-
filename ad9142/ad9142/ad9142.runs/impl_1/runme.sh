...
HD_PWD='D:/Work/vivadoProject/ad9142/ad9142/ad9142.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dac_design_wrapper.tcl -notrace
