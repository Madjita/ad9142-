...
HD_PWD='D:/Work/vivadoProject/ad9142/ad9142/ad9142.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac_design_wrapper.tcl
