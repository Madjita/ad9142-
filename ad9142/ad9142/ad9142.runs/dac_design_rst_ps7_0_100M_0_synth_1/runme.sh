...
HD_PWD='D:/Work/vivadoProject/ad9142/ad9142/ad9142.runs/dac_design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac_design_rst_ps7_0_100M_0.tcl
